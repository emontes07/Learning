...
Copilot Personalization uses the information from Copilot Memory to create interactions tailored to you; for example, you can tell Copilot your writing style—preferred tone, response length, or usual greetings—so that AI‑generated drafts sound more like you.
...
(m365.cloud.microsoft/chat) (or use your usual method to access Copilot).

**Step 2: Add instructions**

• Click the settings menu *(the …).*
...
Here you can add your personalised instructions. For example, you might specify a formal tone, concise answers, or that summaries should use bullet points. 

You can add your custom instructions in this section. As a reference, here is a guide with examples of instructions you can add to Copilot:
